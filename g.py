...
TOKEN = '8367106563:AAFDutg0EOUwRUYSBz2vrdhhmnyfrEMpGrY' #Enter_Bot_Token_within_the_colons
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -10012181997083   
...
def handle_message(message):
    ...
    if message.text == "Stop Attack 🧡":
        ...
        bot.reply_to(message, "*Heya Master_-_\n\n Join @TOP_SELLER_70 on Telegram*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*My Admins Are*\n\n @TOP_SELLER_70", parse_mode='Markdown')
    else:
